...
<body>
    ...
    <div id="wrap">
        ...
        <div class="main">
        <form action="${ pageContext.servletContext.contextPath }/question/update" method="post">
            <div class="box_wrap">
                <div>
                 ...
                 <div class="button">
	        	<button type="reset" onclick="location.href='${ pageContext.request.contextPath }/index.jsp'"><b>취소</b></button>&nbsp;&nbsp;&nbsp; <button type="update"><b>수정하기</b></button>
            	</div> 
            	</div>
        </form>	
            </div>   
