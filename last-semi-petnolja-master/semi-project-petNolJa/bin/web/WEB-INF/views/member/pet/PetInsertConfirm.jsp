...
<jsp:include page="../../common/header-main.jsp"/>
        ...
        <div>
            ...
            <div id="message">
                <br>
                <h4>감사합니다.</h4>
                <p>고객님의 반려동물 정보 등록이 <b>완료</b> 되었습니다.</p>
                <br>
            </div>
            <br><br><hr><br><br>

                <div id="button" align="center">
                    <button type="reset" onclick="location.href='${ pageContext.request.contextPath }/index.jsp'"><b>메인</b></button>
                </div>
