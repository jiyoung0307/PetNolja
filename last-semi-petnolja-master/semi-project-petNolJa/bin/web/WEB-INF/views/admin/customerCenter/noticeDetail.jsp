...
<div>
    <button  onclick="location.href='${ pageContext.servletContext.contextPath }/notice/select'">목록으로</button>
</div>
...
<script>
     $("#modify").click(function(){
            ...
            location.href = "${ pageContext.servletContext.contextPath }/notice/edit?no=" + noticeNo;
        });
    ...
    $("#delete").click(function(){
        ...
        if(confirm('정말 삭제하시겠습니까?')){
            $.ajax({
            url: "${ pageContext.servletContext.contextPath }/notice/edit",
            type: "post",
